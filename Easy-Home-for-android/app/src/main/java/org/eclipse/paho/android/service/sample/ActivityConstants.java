...
public class ActivityConstants {
  ...
  public static String clientHandlerURL = "";

  public static String baiduAppID = "8750832";
  public static String baiduAPIKey = "QARA6YoZzREiEguAvZDHG5Oo";
  public static String baiduSecretKey = "f7112756b15929a9ca0e4d670bb04d9b";
